    ...
    if (showEmojiPanel) {
      return widget.customStickerPanel != null
          ...
          : StickerPanel(
              ...
              lightPrimaryColor: theme.darkTextColor);
    }
                      ...
                      if (widget.forbiddenText == null)
                        Expanded(
                          child: showSendSoundText
                              ? SendSoundMessage(
                                  onDownBottom: widget.goDownBottom, conversationID: widget.conversationID, conversationType: widget.conversationType)
                              : KeyboardVisibility(
                                  child: ExtendedTextField(
                                      ...
                                      style: TextStyle(color: hexToColor("1a1a1a")),
                                      ...
                                      specialTextSpanBuilder: PlatformUtils().isWeb
                                          ...
                                          : DefaultSpecialTextSpanBuilder(
                                              isUseQQPackage: (widget.model.chatConfig.stickerPanelConfig?.useTencentCloudChatStickerPackage ?? true) ||
