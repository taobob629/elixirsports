  ...
  Widget buildBody(BuildContext context) {
    return BaseScaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: Obx(() => controller.pageState == 4
                ? InteractiveViewer(
                    // 允许缩放
                    scaleEnabled: true,
                    // 最小缩放比例
                        ...
                        child: Stack(
                          children: [
                            ...
                            if (controller.loadComplete.value)
                              ...controller.seatModel.value.computers
                                  .map((element) {
                                // 根据比例调整每个座位图的坐标
                                double scaledX =
          ...
          Container(
            height: MediaQuery.of(context).size.height *
                0.3, // 根据屏幕高度的30%来设置底部区域的高度
            constraints: BoxConstraints(
              minHeight: 150.h, // 设置最小高度
              maxHeight: 250.h, // 设置最大高度
            ),
            decoration: BoxDecoration(
              color: Colors.white,
