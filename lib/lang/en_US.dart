const Map<String, String> en_US = {
  ...
  'Mine': 'Mine',
  'LOG IN': 'LOG IN',
  'Please enter the store name/address.':
      'Please enter the store name/address.',
  ...
  'After arriving at the store, scan the code or enter the unlock code to unlock it':
      'After arriving at the store, enter the unlock code to unlock computer',
  ...
  'Scan the code to log on to the computer':
      'Scan the code to log on to the computer',
  ...
  'So that everyone can get to know you better.':
      'So that everyone can get to know you better.',
